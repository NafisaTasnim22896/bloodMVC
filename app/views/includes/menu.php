        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-1 col-md-1 col-sm-6 col-6">
                    ...
                    <a href="#">
                        <div class="logo">
                        <img src="<?php echo URLROOT; ?>../img/new1.png" alt="">
                        </div>
                    </a>
                </div>
                            ...
                            <ul>
                                ...
                                <li><a href="">Services</a>
                                    <ul class="submenu">
                                        ...
                                        <li><a href="<?php echo URLROOT; ?>/pages/donorList">Find doner</a></li>
                                    </ul>
                                </li>
                                <li><a href="<?php echo URLROOT; ?>/views/eligibility">Eligibility</a></li>
                                <li><a href="<?php echo URLROOT; ?>/views/about">About us</a></li>
                            ...
                            <ul>
                                ...
                                <li><a href="">Services</a>
                                    <ul class="submenu">
                                        ...
                                        <li><a href="<?php echo URLROOT; ?>/users/login">Find doner</a></li>
                                    </ul>
                                </li>
                                <li><a href="<?php echo URLROOT; ?>/views/eligibility">Eligibility</a></li>
                                <li><a href="<?php echo URLROOT; ?>/views/about">About us</a></li>
